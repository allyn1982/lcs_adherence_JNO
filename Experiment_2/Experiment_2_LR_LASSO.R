...
x_exp_1_significant <- model.matrix(my_data$adherence_altered ~
                    ...
                    my_data$median_income_category_new)[, -1]
...
set.seed(5)
cv.glmmod <- cv.glmnet(x_exp_1_significant, y=my_data$adherence_altered, alpha=1, nfolds = 10)
plot(cv.glmmod)
